...
/*=============== REMOVE MENU MOBILE =============== para remover o menu quando clicamos em qualquer dos separadores*/
...
/*=============== ADD SHADOW HEADER =============== para dar sombra quando fazemos scroll na barra de navegação*/
const shadowHeader = () =>{
...
sr.reveal(`.home__coffe`, {delay: 1000, distance:'200px', duration: 1500})
...
sr.reveal(`.about__coffe`, {delay: 1000})
